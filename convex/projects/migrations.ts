...
// Step 1: Run this migration from the Convex dashboard (internal.projects.removeProjectUpvotesField)
// Step 2: Once migration completes, remove the field from convex/schema.ts in a follow-up PR
